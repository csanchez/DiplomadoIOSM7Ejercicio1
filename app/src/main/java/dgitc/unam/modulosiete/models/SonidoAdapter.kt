package dgitc.unam.modulosiete.models
...
class SonidoAdapter(context: Context,private val list:ArrayList<SonidoModelo>): BaseAdapter() {
    ...
    override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
        var view=inflter.inflate(R.layout.sonido_item,null)
